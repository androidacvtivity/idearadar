...
List<IdeaAssumption> buildStarterAssumptions(Idea idea) {
  ...
  return [
    IdeaAssumption(
      ...
      nextExperiment: 'Interview 5 target users and ask for recent examples of the problem.',
    ),
    IdeaAssumption(
      id: '${seed}_customer',
      ideaId: idea.id,
      ...
      nextExperiment: 'Define one narrow customer segment and speak with 5 people in it.',
    ),
    IdeaAssumption(
      id: '${seed}_pay',
      ideaId: idea.id,
      ...
      nextExperiment: 'Ask 5 target customers for a concrete price they would pay.',
    ),
    IdeaAssumption(
      ...
      nextExperiment: 'Choose one acquisition channel and try to reach 10 target customers.',
    ),
    IdeaAssumption(
      ...
      nextExperiment: 'Define the smallest useful MVP and estimate time, cost, and technical risk.',
    ),
    IdeaAssumption(
      id: '${seed}_difference',
      ideaId: idea.id,
      ...
      nextExperiment: 'Compare the idea with 5 alternatives and identify one defensible advantage.',
    ),
  ];
}
