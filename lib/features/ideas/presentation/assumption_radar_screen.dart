          ...
          children: [
            for (final confidence in AssumptionConfidence.values)
              ListTile(
                ...
                trailing: assumption.confidence == confidence
                    ...
                    Card(
                      ...
                      child: ListTile(
                        ...
                        leading: CircleAvatar(
                          child: Text('${assumption.confidencePercent}'),
                        ),
                        title: Text(assumption.title),
                        subtitle: Text(
                          '${_confidenceText(context, assumption.confidence)} · ${assumption.evidenceCount}',
                        ),
